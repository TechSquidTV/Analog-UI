...
const colorMaps = {
  red: { bg: '#3a0808', core: '#fc8888', mid: '#d44040', edge: '#8c1c1c', bloom: 'rgba(212, 64, 64, 0.7)' },
  green: { bg: '#0f2913', core: '#bdf2c3', mid: '#5ca34d', edge: '#2b5e20', bloom: 'rgba(92, 163, 77, 0.7)' },
  amber: { bg: '#2e1d05', core: '#fcefc7', mid: '#d19324', edge: '#8a5b0f', bloom: 'rgba(209, 147, 36, 0.7)' },
  blue: { bg: '#081e36', core: '#c5e2ff', mid: '#3b86e0', edge: '#164882', bloom: 'rgba(59, 134, 224, 0.7)' },
  white: { bg: '#404040', core: '#ffffff', mid: '#f4f4f4', edge: '#a3a3a3', bloom: 'rgba(255, 255, 255, 0.8)' }
};
...
export const AnalogIndicator = React.forwardRef<HTMLDivElement, AnalogIndicatorProps>(
  ({ className, isOn = false, color = 'red', size = 'md', variant = 'chrome', shape = 'round', lighting, ...props }, ref) => {
    ...
    return (
      <div 
        ref={ref}
        className={cn("relative inline-flex items-center justify-center shrink-0", sizeMaps[size], className)}
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              borderRadius: shape === 'square' ? '8%' : '50%',
              background: `linear-gradient(var(--analog-light-angle-lens, 180deg), rgba(255,255,255,calc(0.5 * var(--analog-light-power, 1))) 0%, transparent 50%)`
            }}
          />
