    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 rounded-full overflow-hidden analog-surface-recess">
            ...
            <div className={cn(
               "absolute inset-[var(--spacing-track-padding)] rounded-full bg-black shadow-[inset_0_1px_3px_rgba(0,0,0,1)] flex items-center justify-between px-[24px]"
            )}>
              {/* Labels */}
              <span className="font-mono text-[9px] font-bold text-[#555] opacity-0 group-data-[checked]:opacity-100 transition-opacity duration-300">ON</span>
              <span className="font-mono text-[9px] font-bold text-[#555] opacity-50 group-data-[checked]:opacity-0 transition-opacity duration-300">OFF</span>
            </div>
          </div>
          
        {/* The Thumb */}
        <BaseSwitch.Thumb
            className="analog-switch-thumb absolute left-1/2 top-1/2 -mt-[14px] -ml-[14px] w-[28px] h-[28px] pointer-events-none"
        >
             ...
             <div className="analog-switch-cylinder absolute inset-0 rounded-full">
                  ...
                  return (
                    <div 
                      ...
                      className={cn(
                        ...
                        isChrome ? "bg-neutral-400 border border-neutral-500/20" : "bg-[#121212] border border-[#222]/50"
                      )} 
                      style={{ 
                ...
                <div className={cn(
                  ...
                  <div 
                    className={cn(
                      "analog-foil z-[2]",
                      isChrome ? "opacity-30 mix-blend-screen" : "opacity-20 filter grayscale brightness-50"
                    )}
                  />
                  ...
                  <div className="absolute inset-0 rounded-full z-[3]"
                       style={{ boxShadow: `inset calc(sin(var(--analog-light-angle-thumb, 180deg)) * 2px) calc(cos(var(--analog-light-angle-thumb, 180deg)) * -2px) 2px rgba(255,255,255,calc(0.8 * var(--analog-light-power, 1)))` }} />
                </div>
             </div>
          </div>
        </BaseSwitch.Thumb>
