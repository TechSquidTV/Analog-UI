...
- [Push Toggle](/docs/components/push-toggle): latching push control with optional LED feedback
- [Toggle Button Group](/docs/components/toggle-button-group): grouped push toggles with LED selection
...
- [Gauge](/docs/components/gauge): circular LCD monitor with dial-face styling
