...
- [Anisotropic Dial](/docs/components/dial): rotary input with metallic foil response
- [Professional Audio Fader](/docs/components/slider): linear fader with recessed travel and machined thumb
- [Industrial Power Rocker](/docs/components/toggle): heavy rocker control with optional LED states
- [3D Square Button](/docs/components/square-button): momentary square plunger with deep 3D travel
- [3D Square Toggle](/docs/components/square-toggle): latching square control with optional LED feedback
- [Machined Cylinder Switch](/docs/components/switch): cylindrical track switch with rolling thumb behavior
